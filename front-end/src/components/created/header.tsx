...
function Header() {
  ...
  return (
    <>
      <header className="bg-[url('../../public/bg-avatar.png')] bg-no-repeat bg-cover p-7">
        <div className="flex justify-center items-center md:gap-20 lg:gap-20 p-6 bg-sky-900 m-3 md:m-6 rounded-2xl ">
          <div id="texts" className="flex flex-col justify-center items-center">
